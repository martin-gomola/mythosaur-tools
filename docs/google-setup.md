...
- for standalone IDE use, set `MT_WORKSPACE_HOST` directly in `.env`
...
- set `MT_GOOGLE_MAPS_API_KEY` in `.env`
- optionally set `MT_GOOGLE_MAPS_PLATFORM`
...
- `MT_GOOGLE_CREDENTIALS_FILE=/secrets/google-credentials.json`
- `MT_GOOGLE_TOKEN_FILE=/secrets/google-token.json`
- `MT_GOOGLE_*_ENABLED=true|false`
- `MT_GOOGLE_MAPS_API_KEY=<your-maps-api-key>`
- `MT_GOOGLE_MAPS_PLATFORM=<your-project-or-platform-id>`
